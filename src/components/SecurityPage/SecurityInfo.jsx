            ...
            <OuterSquare>
                ...
                <HeroRow>
                    <ContentBox>
                        <TextSquare>
                            <h1>
                                Your Security is Our <br/> <span>Top Priority</span>
                            </h1>
                            <p style={{marginTop: "-1rem", fontSize: "0.9rem"}}>
                                At YourBank, we understand the importance of keeping your financial information secure.
                                We employ robust security measures and advanced technologies to protect your personal
                                and financial data. Rest assured that when you bank with us, your security is our utmost
                                priority.
                            </p>
                        </TextSquare>
                        <ImageSquare>
